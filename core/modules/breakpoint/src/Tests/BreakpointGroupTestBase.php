...
abstract class BreakpointGroupTestBase extends WebTestBase {
   ...
   */
  public function verifyBreakpointGroup(array $group, array $compare_set = NULL) {
    $properties = array(
      'label',
      'id',
      'breakpoints',
    ...
    $compare_set = is_null($compare_set) ? breakpoint_load_breakpoint_group($group['id']) : $compare_set;
